          ...
          <div className="container px-5 py-6 mx-auto w-auto">
            ...
            <div id="blog" className="flex ml-12 px-6 xl:px-0 py-0 flex-row w-1/2">
              ...
              <div className="mt-10 lg:ml-[10rem] ">
                <div className="w-[20rem] grid md:w-[40rem] md:max-w-xl md:grid-cols-2 lg:grid-cols-1 gap-6">
                      ...
                      <div key={key}>
                        ...
                        <div className="bg-white px-10 py-6 rounded-bl-xl rounded-br-xl">
                          ...
                          <div className="w-full mt-4 justify-end flex items-center cursor-pointer">
                            <Link href={`/blogpost/${BlogRes[item].slug}`}><p className="text-base tracking-wide text-indigo-500">
                              Read more
                            </p></Link>
                            <svg
